...
/*-----------------------------------------------
  [] Make sure there is a way to add, edit or
     delete tasks, projects and lists. 
  [] Also consider clearing out completed tasks
     - manually, after some time, at midnight
     every night or such like.
  [] Some settings that allow the user to adjust
     how the app works, like displaying or hiding
     information
