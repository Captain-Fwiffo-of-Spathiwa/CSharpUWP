...
namespace TaskManagement.Models
{
    public class TaskList
    {
        ...
        /// <summary>
        /// Get a readonly list of Tasks.
        /// Note: The tasks themselves are still mutable.
        /// </summary>
        /// <returns>The list of Tasks in the TaskList.</returns>
        public IReadOnlyList<Task> GetTasks()
        {
            /* ------------------------------------------------------------
                This is barely consting anything but I can't be bothered
                with the extra runaround C# needs to lock everything down.
               -----------------------------------------------------------*/
            return Tasks;
        }
    }
