...
namespace TaskManagement
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        RepeatingTask RepeatingWeeklyTask0 = new("Deliver papers repeatedly", DateTime.Now + TimeSpan.FromDays(7), Frequency.Weekly);
        RepeatingTask RepeatingWeeklyTask1 = new("Check flight obsessively", DateTime.Now + TimeSpan.FromDays(7), Frequency.Weekly);
        RepeatingTask RepeatingDailyTask2 = new("Sweep the OCD away", DateTime.Now + TimeSpan.FromDays(1), Frequency.Daily);
        RepeatingTask RepeatingDailyTask3 = new("Water plants to death", DateTime.Now + TimeSpan.FromDays(1), Frequency.Daily);

        Habit Habit0 = new("Write code", DateTime.Now, Frequency.Daily, 0);
        Habit Habit1 = new("Write more code", DateTime.Now, Frequency.Daily, 0);
        ...
        public MainPage()
        {
            ...
            // Assessment 4 from here
            TestSaveAndLoad();

            // Assessment 5 from here
            TestSorting();
        }
        ...
        private void TestSaveAndLoad()
        {
            ...
            TaskList taskList0 = new("First TaskList");
            TaskList taskList1 = new("Second TaskList");

            taskList0.AddTask(Task0);
            taskList0.AddTask(Task1);
            taskList0.AddTask(RepeatingWeeklyTask0);
            taskList0.AddTask(RepeatingWeeklyTask1);
            taskList0.AddTask(Habit0);
            taskList0.AddTask(Habit1);

            taskList1.AddTask(Task2);
            taskList1.AddTask(Task3);
            taskList1.AddTask(RepeatingDailyTask2);
            taskList1.AddTask(RepeatingDailyTask3);
            taskList1.AddTask(Habit2);
            taskList1.AddTask(Habit3);
        ...
        private void TestSorting()
        {
            ...
            Debug.WriteLine("\nCollection after Sort() by Description: \n");
            taskCollection.GetTasksSortedByName();
        }
    }
}
